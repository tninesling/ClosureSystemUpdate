...
#pragma message ("Large file source=" STRINGIFY(_LARGEFILE_SOURCE))

#if defined(__cplusplus) && defined(__GNUC__)
 #pragma message ("Compiling as C++ code: version=" STRINGIFY(__cplusplus))
 #if(__cplusplus>=201103L)
   #pragma message ("Defining typeof")
   //#define typeof(...) std::remove_reference_t<decltype(__VA_ARGS__)>;
   #define typeof __typeof__
 #endif
 #define _cplusplus_
#else
 #pragma message ("Compiling as C code...")
#endif
