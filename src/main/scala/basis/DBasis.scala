...
/*
    ...
    println(s"Liftable: ${liftable.filter(_.conclusion.contains("10"))}")
    println(s"Lifted to: ${lifted.filter(_.conclusion.contains("10"))}")
    println(s"Broken and broken lifted: ${broken | brokenLifted}")
    println(s"Body-built to: ${updated.filter(_.conclusion.contains("10"))}")
    println(s"Refined to: ${filteredUpdatedAndLifted.filter(_.conclusion.contains("10"))}")
*/
